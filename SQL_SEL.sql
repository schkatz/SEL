...
CREATE TABLE [Teams] (
  ...
  CONSTRAINT [fk_Teams_Users1]
    ...
    REFERENCES [SEL].[Users] ([User_ID])
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT [fk_Teams_Leagues1]
    FOREIGN KEY ([TeamLeague_ID])
    REFERENCES [SEL].[Leagues] ([League_ID])
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE [Users] (
  ...
  CONSTRAINT [fk_Users_Teams]
    ...
    REFERENCES [SEL].[Teams] ([Team_ID])
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT [fk_Users_Roles1]
    FOREIGN KEY ([UserRole_ID])
    REFERENCES [SEL].[Roles] ([Role_ID])
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE [PlayerStats] (
  ...
  CONSTRAINT [fk_PlayerStats_Accounts1]
    ...
    REFERENCES [SEL].[Accounts] ([AccountUser_ID] , [AccountGame_ID])
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
